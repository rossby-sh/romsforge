...
!
     ...
     &      'Message Passage: multi-model coupling ............'/)
        ...
        character (len=80) :: my_fc = "/usr/local/mpi/intel21/mvapich2-2.3.4/bin/mpif90"
        character (len=160) :: my_fflags = "-heap-arrays 1024 -fp-model source -mcmodel=large -xHost -no-ip -O2 -free -free"
