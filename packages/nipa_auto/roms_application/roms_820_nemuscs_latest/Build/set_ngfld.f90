     ...
     &                      Finp, Fout, update)
!
!svn $Id: set_ngfld.F 795 2016-05-11 01:42:43Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      real(r8) :: SecScale, fac, fac1, fac2
!
!----------------------------------------------------------------------
...
!
      ...
      update=.TRUE.
!
!  Set linear-interpolation factors. Fractional seconds are
