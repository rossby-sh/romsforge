...
#== Define Inputs files =======================================================
My_Ini='/data/shjo/clim/eccov4_clm_ini_fennel.nc' # Initial file name (to create)
...
ncI['SdetritusC'][0]=0.04
ncI['LdetritusC'][0]=0.04
ncI['RdetritusC'][0]=0.04
ncI['SdetritusN'][0]=0.04
ncI['LdetritusN'][0]=0.04
ncI['RdetritusN'][0]=0.04
ncI.close()
