...
pth='D:/shjo/ROMS_inputs/NWP15km/N36/obs/'
outputFile=pth+'obs_phyt_15km_N36_3Square_XY.nc'

NC=Dataset(pth+'obs_phyt_15km_N36_NoSquare.nc','r')

MAT=io.loadmat(pth+'XYgrid_phyt_3Square.mat')
