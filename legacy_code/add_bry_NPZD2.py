...
My_Bry='/data/shjo/mcc/jul/roms_inputs/nifs_bry_20250630-20250801.nc' # Initial file name (to create)
...
OGCMS=[ncdir+i for i in os.listdir(ncdir) if (i.endswith('.nc') & i.startswith('CMEMS_') ) ]
# Get My Grid info
ncG=Dataset(My_Grd)
...
if NSEW[0]:
    ...
    #for i in ['temp']:
        ...
        if i=='NO3' :
            OGCM_npth=NO3NC+"CMEMS_nut_20250630-20250801.nc";
        elif i=='phyt':
            OGCM_npth=phytNC+"CMEMS_pft_20250630-20250801.nc";
        elif i=='zoop':
            OGCM_npth=zoopNC;
        elif i=='detr':
            OGCM_npth=detrNC;
        ...
        tmp_data=xr.open_mfdataset(OGCM_npth,parallel=Parallel)[OGCMVar[i]][TIMES_co,:,bry_lat_co,bry_lon_co].squeeze().values
