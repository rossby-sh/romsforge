...
pthI_lres=pth+"NWP4_ini_DA_8401.nc"
pthI_hres=pth+"NWP12_ini_DA_lev36_8401.nc"
...
idt=0
with Dataset(pthI_lres, maskandscale=True) as nc_raw:
...
# load hres initial
with Dataset(pthI_hres, maskandscale=True) as nc_raw:
    nc = ut.MaskedNetCDF(nc_raw)
...
with Dataset(pthI_hres, mode='a') as nc:
