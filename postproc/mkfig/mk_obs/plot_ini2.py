...
ncS=Dataset("D:/shjo/MCC/tmp/NWP15_ini_9313_HTS.nc")
...
# draw_roms_pcolor(lon, lat, phytS, timestamp=t_str, varname='025_test',\
#                  units='millimole_nitrogen meter-3', log_scale=True, clim=None,\
...
draw_roms_pcolor(lon, lat, tempS, timestamp='', varname='After data assimilation',\
