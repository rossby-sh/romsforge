...
draw_roms_pcolor(lon, lat, phytS, timestamp=t_str, varname='Mean surface phyto',\
                 units='millimole_nitrogen meter-3', log_scale=True, clim=None,\
                     output_path=wpth+'phyt_'+t_str+'.png', cmap=plt.get_cmap('jet',27)) 
...
draw_roms_pcolor(lon, lat, saltS, timestamp=t_str, varname='Mean surface salt',\
                    units=f'psu', log_scale=False, clim=(32.5,35.5),\
                        output_path=wpth+'salt_'+t_str+'.png',\
