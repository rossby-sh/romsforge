...
# 파일 열기
obs_file = 'D:/shjo/ROMS_inputs/roms_obs_sst_phyto_30km_250501_250531.nc'
ds = nc.Dataset(obs_file)

Gnm='D:/shjo/ROMS_inputs/roms_grd_fennel_15km_smooth_v2.nc'
ncG=nc.Dataset(Gnm)
...
if type is not None:
    ...
    X, Y, val, err, time_dates = X[sst_idx], Y[sst_idx], val[sst_idx], err[sst_idx], time_dates[sst_idx]
