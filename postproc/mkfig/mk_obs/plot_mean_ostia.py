...
SST=ncX.mean(dim='time')

title=''

wpth='D:/shjo/MCC/nifs_jun_q_obs_sst/figs/'
...
lon,lat=SST.longitude.values,SST.latitude.values
...
# draw_roms_pcolor(lon, lat, SST, timestamp=t_str, varname='Mean OSTIA (Apr)',\
#                     units=f'degree', log_scale=False, clim=(-1,32),\
#                         output_path=wpth+'ostia/'+t_str+'.png',\
