...
outputFile = 'D:/shjo/ROMS_inputs/obs/pro/obs_KODC_N20_06.nc'
if os.path.exists(outputFile):
    os.remove(outputFile)
    
Table1=pd.read_excel(pth+'202506_KODC_EastSea.xlsx')
Table2=pd.read_excel(pth+'202506_KODC_WestSea.xlsx')
Table3=pd.read_excel(pth+'202506_KODC_SouthSea.xlsx')
# Table4=pd.read_excel(pth+'202506_KODC_ECS.xlsx')
...
for ii in df_sorted.groupby(level=0):
    ...
    obs_error = np.maximum(df_obs["error"].values, 1e-3)  # 최소값 제한
    ...
    obs_variance = [0, 0, 0, 0, 0, 0.205, 0.0025, 0, 0.009, 0, 0]
