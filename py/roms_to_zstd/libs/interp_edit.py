...
def vertical_interpolation_parallel(depth3d, std_height, roms_var, stdvdepth, n_jobs=-1):
    ...
    def interpolate_column(i):
        ...
        for j in range(lat_size):
            ...
            depth_profile = depth3d[:, j, i] * std_height[j, i]
            ...
            if np.sum(valid_mask) > 2:
                interp_func = interp1d(depth_profile[valid_mask], value_profile[valid_mask], 
                                       ...
                                       fill_value=(value_profile[valid_mask][0], np.nan))  
