...
Spth01='D:/shjo/ROMS_OUTS/sst/NWP15_ini_9256_HTS.nc'
Spth02='D:/shjo/ROMS_OUTS/sst_phyt/NWP15_ini_9256_HTS.nc'
...
ncS01=Dataset(Spth01)
ncS02=Dataset(Spth02)


times=ncS01['ocean_time'][:]


phytS01=ncS01['phytoplankton'][0,-1].data
phytS01[phytS01>1000]=np.nan
phytS02=ncS02['phytoplankton'][0,-1].data
phytS02[phytS02>1000]=np.nan
    
phytS_diff=phytS01-phytS02
...
draw_roms_pcolor(lon, lat, phytS_diff, timestamp='t_str', varname='Surface phyt',\
                 units='millimole_nitrogen meter-3', log_scale=True, clim=None,\
...
# draw_roms_pcolor(lon, lat, tempS, timestamp=t_str, varname='Surface temp',\
#                     units=f'degree', log_scale=False, clim=(-1,32),\
#                         output_path='D:/shjo/ROMS_OUTS/figs/nifs_phyt_or/temp/'+t_str+'.png',\
...
#                         output_path='D:/shjo/ROMS_OUTS/figs/nifs_phyt_or/salt/'+t_str+'.png',\
