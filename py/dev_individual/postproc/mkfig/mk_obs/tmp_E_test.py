...
Spth='D:/shjo/E_test/Case_30SE/'

title='nifs-may'

wpth='D:/shjo/E_test/Case_30SE/figs/'
...
for f in flist:
    ...
    with Dataset(f) as ncS:
        ...
        for i in range(len(times)):
            ...
            draw_roms_pcolor(lon, lat, phytS, timestamp=t_str, varname='Case_3SE',\
                             units='millimole_nitrogen meter-3', log_scale=True, clim=None,\
            ...
            draw_roms_pcolor(lon, lat, tempS, timestamp=t_str, varname='Case_30SE',\
