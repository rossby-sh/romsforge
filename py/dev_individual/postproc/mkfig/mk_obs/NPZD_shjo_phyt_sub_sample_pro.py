...
outputFile = 'D:/shjo/ROMS_inputs/NWP15km/N36/obs/obs_phyt_15km_N36_3Square.nc'
...
#for t in range(5):
    ...
    obs_error = obs_value * 0.03
    obs_error=obs_error**2
    print('!!! obs_error=obs_value*0.3 !!!')
...
# merged=xr.open_dataset('D:/shjo/ROMS_inputs/NWP15km/N36/obs/final/supobs_sst_phyt_15km_N36_NoSquare.nc')
...
#         obs_variance[var_type - 1] = np.mean(var_error)
# obs_variance[obs_variance==1]=0
...
# NC=Dataset('D:/shjo/ROMS_inputs/NWP15km/N36/obs/final/supobs_sst_phyt_15km_N36_NoSquare.nc','a')
# NC['obs_variance'][:]=obs_variance
# NC.close()
