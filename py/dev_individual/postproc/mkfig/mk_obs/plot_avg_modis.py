...
# val=ds_combined.chlor_a.loc[dict(time=slice(9312,9317))].mean(dim='time',skipna=True).values/(0.02*6.625*12)
...
ax.set_title('MODIS monthly mean', fontsize=16,pad=10)
