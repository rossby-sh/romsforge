...
#-- Define OGCM path ----------------------------------------------------------
ncdir='C:/Users/ust21/shjo/projects/myROMS/00utc/'
sshNC=ncdir+'HYCOM_20250301.nc'
tempNC=ncdir+'HYCOM_20250301.nc'
saltNC=ncdir+'HYCOM_20250301.nc'
uNC=ncdir+'HYCOM_20250301.nc'
vNC=ncdir+'HYCOM_20250301.nc'

#-- Define Parameters ---------------------------------------------------------
Ini_title='NWP 15km ROMS-NPZD' # title for NC description
...
create_ini_NPZD(My_Ini,mask,topo,MyVar,Ini_time_num,My_time_ref,Ini_title)
